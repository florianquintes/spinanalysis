...
def export(
    ...
    path : str, optional
        ...
        will be stored in the current working directory, default is ``None``.
    pkind : str or list of str, optional
        ...
        'all', default is ``'all'``.
    pname : str, optional
        Give the basename of the profile, default is ``'all'``.
    """
    root = PROFILE_ROOT
...
def _get_profile_paths(pfolder: Path, pname: str = "all") -> list[Path]:
    ...
    pname : str, optional
        Basename of the profile, default is ``'all'``.
...
def add_profile(profile: dict, pkind: str, pname: str = "") -> None:
    ...
    pname : str, optional
        ...
        will be generated by :func:`_get_profile_name`, default is ``''``.
